...
const STYLES = `
  .admp-page { font-family: 'DM Sans', sans-serif; max-width: 1400px; margin: 0 auto; padding: 12px 0 48px; }
  .admp-heading { font-size: 28px; font-weight: 800; margin: 0 0 4px; letter-spacing: -0.02em; color: #1a1a1a; }
  .admp-sub { font-size: 14px; color: #888; margin: 0 0 24px; }
  ...
  .admp-page-btn {
    ...
    font-family: 'DM Sans', sans-serif; transition: all 0.15s; color: #444;
  }
  ...
  @keyframes admpSpin { to { transform: rotate(360deg) } }

  /* ── Medium screens: hide ID col ── */
  ...
  @media (max-width: 640px) {
    .admp-page { padding: 8px 0 60px; }
    .admp-heading { font-size: 22px; }
